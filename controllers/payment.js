...
exports.createPayment = async (req, res) => {
    const {  subscriptionId, status, createdAt, endDate } = req.body;
  try {
...
exports.sendEmailAfterPayment = async (req, res) => {
    const { email, name, subscriptionId, status, createdAt, endDate } = req.body;
    ...
    const mailOptions = {
        ...
        html: ` <h1>Hi ${name}</h1>
                ...
                <h3>Subscription Id: ${subscriptionId}</h3>
                <h3>Status: ${status}</h3>
                <h3>Start Date: ${createdAt}</h3>
...
exports.sendEmailBeforeExpirationDate = async (req, res) => {
    const  email = "karamelmannai@gmail.com"
        , name= "karam"
        , subscriptionId= "gdgd"
        , status="gdgdgd"
        , createdAt="gdgd"
...
exports.sendEmailAfterExpirationDate = async (req, res) => {
    const { email, name, subscriptionId, status, createdAt, endDate } = req.body;
    const transporter = nodemailer.createTransport({
        service: "gmail",
        auth: {
            user: "khaninmonin@gmail.com",
            pass: "karam123456",
        },
    });
    const mailOptions = {
...
<div align="center" class="alignment" style="line-height:10px"><a href="http://www.example.com/" style="outline:none" tabindex="-1" target="_self"><img alt="Logo" 
class="big" src="https://user-images.githubusercontent.com/58667227/218262555-710a7b0c-ac49-49a3-b7d5-12fc1d7a8295.png" style="display: block; height: auto; border: 0; width: 640px; max-width: 100%;" title="Logo" width="640"/></a></div>
</td>
</tr>
</table>
</td>
...
<tr>
<td>
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #ff8779; color: #000000; width: 640px;" width="640">
<tbody>
<tr>
...
<tr>
<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
<div align="center" class="alignment" style="line-height:10px"><img alt="Image" class="big" src="https://user-images.githubusercontent.com/58667227/222170292-d545f9a0-61be-435f-934e-632a9d4a18cf.png" style="display: block; height: auto; border: 0; width: 481px; max-width: 100%;" title="Image" width="481"/></div>
</td>
</tr>
</table>
...
<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;"><span style="font-size:58px;"><strong>Dear karam,</strong></span></p>
</div>
</div>
</td>
</tr>
...
<tr>
<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
<div align="center" class="alignment" style="line-height:10px"><img alt="Image" src="https://user-images.githubusercontent.com/58667227/222170282-4b24af80-608d-4062-92fc-3473fd75651b.png" style="display: block; height: auto; border: 0; width: 24px; max-width: 100%;" title="Image" width="24"/></div>
</td>
</tr>
</table>
<table border="0" cellpadding="0" cellspacing="0" class="text_block block-2" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
...
<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px;"><strong>0123963</strong></p>
</div>
</div>
</td>
</tr>
...
<tr>
<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
<div align="center" class="alignment" style="line-height:10px"><img alt="Image" src="https://user-images.githubusercontent.com/58667227/222170286-335fe7b2-6a10-4e95-a24f-560ade29565e.png" style="display: block; height: auto; border: 0; width: 22px; max-width: 100%;" title="Image" width="22"/></div>
</td>
</tr>
</table>
...
<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px;"><strong>22 January 2020</strong></p>
</div>
</div>
</td>
</tr>
...
<tr>
<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
<div align="center" class="alignment" style="line-height:10px"><img alt="Image" src="https://user-images.githubusercontent.com/58667227/222170288-15330885-5ddf-4513-bf02-0e308141b4ef.png" style="display: block; height: auto; border: 0; width: 25px; max-width: 100%;" title="Image" width="25"/></div>
</td>
</tr>
</table>
<table border="0" cellpadding="10" cellspacing="0" class="text_block block-2" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
...
<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px;"><strong>$40.00</strong></p>
</div>
</div>
</td>
</tr>
...
<div style="font-family: sans-serif">
<div class="" style="font-size: 14px; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 21px; color: #ffffff; line-height: 1.5;">
<p style="margin: 0; font-size: 14px; text-align: left; mso-line-height-alt: 21px;">Company Name LLC, represented by John Doe,</p>
...
<div style="font-family: sans-serif">
<div class="" style="font-size: 14px; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 16.8px; color: #ffffff; line-height: 1.2;">
<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;">Pro Plan</p>
</div>
</div>
</td>
</tr>
...
<div style="font-family: sans-serif">
<div class="" style="font-size: 14px; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 16.8px; color: #ffffff; line-height: 1.2;">
<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;">$40.00</p>
</div>
</div>
</td>
</tr>
...
<div style="font-family: sans-serif">
<div class="" style="font-size: 14px; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 16.8px; color: #ffffff; line-height: 1.2;">
<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;">1</p>
</div>
</div>
</td>
</tr>
...
<div style="font-family: sans-serif">
<div class="" style="font-size: 14px; font-family: Lato, Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 21px; color: #ffffff; line-height: 1.5;">
<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 30px;"><span style="font-size:16px;">Payment Method:</span><br/><span style="font-size:20px;"><strong>CARD</strong></span></p>
</div>
</div>
</td>
</tr>
...
<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 28.8px;"><span style="font-size:16px;">Subtotal:<strong> $40.00</strong></span><br/><span style="font-size:16px;">Amount Due: <strong>$40.00</strong></span></p>
</div>
</div>
</td>
</tr>
...
<tr>
<td style="padding:0 10px 0 0px;"><a href="http://www.example.com/" target="_self"><img alt="Facebook" height="32" src="https://user-images.githubusercontent.com/58667227/222170272-d948b2b9-6650-49a7-94f3-af5a73c62890.png" style="display: block; height: auto; border: 0;" title="Facebook" width="32"/></a></td>
<td style="padding:0 10px 0 0px;"><a href="http://www.example.com/" target="_self"><img alt="Twitter" height="32" src="https://user-images.githubusercontent.com/58667227/222170309-e8dd90b0-d328-4295-a256-8e27a3a2755d.png" style="display: block; height: auto; border: 0;" title="Twitter" width="32"/></a></td>
<td style="padding:0 10px 0 0px;"><a href="http://www.example.com/" target="_self"><img alt="Instagram" height="32" src="https://user-images.githubusercontent.com/58667227/222170294-aab1d1cf-2c4b-4801-b80c-c96202889f2d.png" style="display: block; height: auto; border: 0;" title="Instagram" width="32"/></a></td>
<td style="padding:0 10px 0 0px;"><a href="http://www.example.com/" target="_self"><img alt="LinkedIn" height="32" src="https://user-images.githubusercontent.com/58667227/222170296-4a884728-1a70-448f-b1fd-d18355132f22.png" style="display: block; height: auto; border: 0;" title="LinkedIn" width="32"/></a></td>
</tr>
</table>
</div>
</td>
...
<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;"><span style="font-size:11px;">Copyright © 2020 All Rights Reserved | <a href="http://www.example.com/" rel="noopener" style="text-decoration: none; color: #0068A5;" target="_blank">Unsubscribe</a></span></p>
<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 16.8px;"><span style="font-size:11px;">You are receiving this email because you signed up on our website [<a href="http://www.example.com/" rel="noopener" style="text-decoration: none; color: #0068A5;" target="_blank">example.com</a>]</span></p>
